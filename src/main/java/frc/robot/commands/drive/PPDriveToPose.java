...
public class PPDriveToPose extends Command {
    ...
    public PPDriveToPose(Drive drive, Pose2d targetPose) {
        this.m_drive = drive;
        this.targetPose = targetPose;
        this.constraints = AutonK.kPathConstraints;
        this.endVelocity = 0;
    }

    public PPDriveToPose(Drive drive, Pose2d targetPose, double endVelocity) {
        this.m_drive = drive;
        this.targetPose = targetPose;
        this.constraints = AutonK.kPathConstraints;
    ...
    public PPDriveToPose(Drive drive, Pose2d targetPose, PathConstraints constraints, double endVelocity) {
        this.m_drive = drive;
        this.targetPose = targetPose;
    ...
    public void initialize() {
        Pose2d currentPose = m_drive.getPose().toPose2d();
        ...
        if (targetPose.getTranslation().getDistance(startingWaypoint.getTranslation()) > AutonK.kPathTolerance){
    ...
    public BooleanSupplier atGoal() {
        return () -> targetPose.getTranslation().getDistance(m_drive.getPose().toPose2d().getTranslation()) < AutonK.kPathTolerance;
    }
